    ...
    <body>
        ...
        <header>
            ...
            <ul class="nav" id="navigation_header">
                    ...
                    <a href="<?php 
                        ...
                        if (isset($_SESSION['nome'])) {
                            ...
                            if (isset($_SESSION['tipo_usuario']) && $_SESSION['tipo_usuario'] == 'colaborador') {
                                ...
                                echo '../PgHome/indexLOGADOCOLABORADOR.php';
                ...
                <li class="mapa"><a href="../paginadosmapas/mapalogado.php" class="mapa">Mapa</a></li>
                <li class="doa"><a href="../html/pagina-de-doacoes-logado.php" class="doa">Doações</a></li>
                <li class="sobre"><a href="../Página de Sobre/aboutlogado.php" class="sobre">Sobre</a></li>
                <li class="Dicas"><a href="../Página Dicas/dicaslogado.php" class="dicas">Dicas</a></li>
                <li class="Login"><a href="../PgHome/index.php" class="login">Sair</a>
